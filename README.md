...
Feeling Ambitions, Igniting Growth
...
- Open the terminal in any preferred location, create a folder name `AcruxApplication`, and move inside with the following command.
```
mkdir AcruxApplication
```
```
cd AcruxApplication
```
...
```
git clone https://github.com/ApurvChatur/AcruxApplication.git
```
...
- Kindly, check the documentation properly and ensure you are setting up the backend for `AcruxApplication`.

## Administration Installation
- Please ensure you have set up the backend for `AcruxApplication`, before setting up the admin.
...
- Kindly, check the documentation properly and ensure you are setting up the administration for `AcruxApplication`.