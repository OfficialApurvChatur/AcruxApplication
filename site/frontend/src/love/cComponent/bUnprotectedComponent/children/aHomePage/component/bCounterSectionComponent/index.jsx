              ...
              return (
                <React.Fragment key={index}>
                  <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
                    <div className="bg-[#603F83] dark:bg-[#C7D3D4] text-[#C7D3D4] dark:text-[#603F83] bg-opacity-60 px-4 py-6 rounded-lg">
                      {
                        each.title === "Frontend Application Deployed" ? (
                          <div className="w-12 h-12 mb-3 inline-flex items-center justify-center rounded-full bg-[#C7D3D4] dark:bg-[#603F83] text-[#603F83] dark:text-[#C7D3D4] flex-shrink-0">
