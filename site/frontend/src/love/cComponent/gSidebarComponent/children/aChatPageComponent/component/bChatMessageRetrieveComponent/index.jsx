    ...
    <>
      <Card 
        className={`
          ...
          bg-[#ACC7B4] dark:bg-[#331B3F]
          border-[#331B3F] dark:border-[#ACC7B4]
          text-[#331B3F] dark:text-[#ACC7B4]`}
      >
        <CardHeader className="flex flex-row items-center justify-between py-2 border-b border-[#331B3F] dark:border-[#ACC7B4]">
        ...
        <CardFooter className="py-2 border-y border-[#331B3F] dark:border-[#ACC7B4] bottom-0">
          <form className="flex w-full items-center space-x-2">
            <Input
              id="message"
              placeholder="Type your message..."
              className="flex-1 border-[#331B3F] dark:border-[#ACC7B4]"
              autoComplete="off"
              value={input}
